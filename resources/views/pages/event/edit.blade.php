    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    <div class="card-body">
                        <form action="{{ route('events.edit', ['id' => $event->id]) }}" class="mb-3" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div>
                            ...
                            <div>
                                ...
                                <input name="name" type="text" class="form-control" id="defaultFormControlInput"
                                    placeholder="Club Name" value="{{$event->name}}" aria-describedby="defaultFormControlHelp" />
                                @if($errors->has('name'))
                            ...
                            <div>
                                ...
                                <input name="slug" type="text" class="form-control" id="defaultFormControlInput"
                                    placeholder="New York" value="{{$event->slug}}" aria-describedby="defaultFormControlHelp" />
                                @if($errors->has('slug'))
                            ...
                            <div>
                                ...
                                <input name="picture" type="file" class="form-control" id="defaultFormControlInput"
                                    placeholder="New York" value="{{$event->picture}}" aria-describedby="defaultFormControlHelp" />
                                <img src="{{$event->picture}}" height="50px" width="100px">
                                <span class="text-info">{{str_replace(env('UPLOAD_URL').'events/', '', $event->picture)}}</span>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    type="time"
                                    class="form-control"
                                    value="{{ $event->start_time ? $event->start_time->format('H:i') : '' }}"
                                    aria-describedby="defaultFormControlHelp" />
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    class="form-control"
                                    id="longitudeInput"
                                    value="{{ $event->end_time ? $event->end_time->format('H:i') : '' }}"
                                    aria-describedby="defaultFormControlHelp" />
                            ...
                            <div>
                                ...
                                <textarea name="description" class="form-control" id="exampleFormControlTextarea1"
                                    rows="3" placeholder="We are please to announce that...">{{$event->description}}</textarea>
