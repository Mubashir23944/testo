    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    <div class="card-body">
                        <form action="{{ route('events.create') }}" class="mb-3" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div>
                            ...
                            <div>
                                ...
                                <input name="name" type="text" class="form-control" id="defaultFormControlInput"
                                    placeholder="Event Name" value="" aria-describedby="defaultFormControlHelp" />
                                @if($errors->has('name'))
                            ...
                            <div>
                                ...
                                <input name="slug" type="text" class="form-control" id="defaultFormControlInput"
                                    placeholder="event-slug" value="" aria-describedby="defaultFormControlHelp" />
                                @if($errors->has('slug'))
