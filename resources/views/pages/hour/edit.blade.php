    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    <div class="card-body">
                        <form action="{{ route('hours.edit', ['id' => $hour->id]) }}" class="mb-3" method="POST">
                            @csrf
                            <div>
                                ...
                                <select name="club_id" class="form-control" id="defaultFormControlInput" aria-describedby="defaultFormControlHelp">
                                    ...
                                    <option value="{{$club->id}}" {{$hour->club_id == $club->id ? 'selected' : ''}}>{{$club->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <select name="day" class="form-control" id="defaultFormControlInput" aria-describedby="defaultFormControlHelp">
                                    ...
                                    <option value="{{$key}}" {{$hour->day == $key ? 'selected' : ''}}>{{$day}}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    type="time"
                                    class="form-control"
                                    value="{{ \Carbon\Carbon::createFromFormat('H:i:s', $hour->opening_time)->format('H:i') }}"
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    type="time"
                                    class="form-control"
                                    value="{{ \Carbon\Carbon::createFromFormat('H:i:s', $hour->closing_time)->format('H:i') }}"
                                    aria-describedby="defaultFormControlHelp" />
