   ...
   <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
       ...
       <div class="app-brand demo ">
           <a href="{{ route('dashboard') }}" class="app-brand-link">
               ...
               <span
                   class="app-brand-text capital menu-text fw-bolder ms-2">{{ env('APP_NAME') }}</span>
           </a>
       ...
       <ul class="menu-inner py-1">
           ...
           <li class="menu-item {{ Request::routeIs('clubs.*') ? 'active' : '' }}">
           ...
           <li class="menu-item {{ Request::routeIs('groups.*') ? 'active' : '' }}">
               <a href="{{ route('groups.index') }}" class="menu-link">
                   <i class="menu-icon tf-icons fa-solid fa-group-arrows-rotate"></i>
                   <div data-i18n="Groups">Groups</div>
               </a>
           </li>
           <!-- <li class="menu-item">
               <a href="{{ route('courts.create') }}" class="menu-link">
                   <i class="menu-icon tf-icons fa-solid fa-solid fa-table-tennis-paddle-ball"></i>
                   <div data-i18n="Court">Court</div>
               </a>
           </li> -->
           <li class="menu-item {{ Request::routeIs('posts.*') ? 'active' : '' }}">
               <a href="{{ route('posts.index') }}" class="menu-link">
                   <i class="menu-icon tf-icons fa-solid fa-pencil"></i>
           ...
           <li class="menu-item {{ Request::routeIs('reservations.*') ? 'active' : '' }}">
               <a href="{{ route('reservations.index') }}" class="menu-link">
                   <i class="menu-icon tf-icons fa-solid fa-calendar-day"></i>
           ...
           <li class="menu-item {{ Request::routeIs('tournaments.*') ? 'active' : '' }}">
               <a href="{{ route('tournaments.index') }}" class="menu-link">
                   <i class="menu-icon tf-icons fa-solid fa-trophy"></i>
                   <div data-i18n="Tournaments">Tournaments</div>
               </a>
           </li>
           <li class="menu-item {{ Request::routeIs('hours.*') ? 'active' : '' }}">
               <a href="{{ route('hours.index') }}" class="menu-link">
                   <i class="menu-icon tf-icons fa-solid fa-hourglass-start"></i>
                   <div data-i18n="Working Hours">Working Hours</div>
               </a>
           </li>
           <li class="menu-item {{ Request::routeIs('events.*') ? 'active' : '' }}">
               <a href="{{ route('events.index') }}" class="menu-link">
                   <i class="menu-icon tf-icons fa-solid fa-calendar-check"></i>
                   <div data-i18n="Events">Events</div>
               </a>
           </li>
           <li class="menu-item {{ Request::routeIs('ads.*') ? 'active' : '' }}">
               <a href="{{ route('ads.index') }}" class="menu-link">
                   <i class="menu-icon tf-icons fa-solid fa-audio-description"></i>
                   <div data-i18n="User Ads">User Ads</div>
               </a>
           </li>
           ...
           <li class="menu-item {{ Request::routeIs('cms.*') ? 'active' : '' }}">
               <a href="{{ route('cms.edit') }}" class="menu-link">
                   <i class="menu-icon tf-icons fa-solid fa-desktop"></i>
           ...
           <li class="menu-item {{ Request::routeIs('devices.*') ? 'active' : '' }}">
               <a href="{{ route('devices.index') }}" class="menu-link">
                   <i class="menu-icon tf-icons fa-solid fa-mobile"></i>
                   <div data-i18n="User Devices">User Devices</div>
               </a>
           </li>
           <!-- <li class="menu-item">
